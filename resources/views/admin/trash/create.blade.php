...
<div class="col-sm-12">
  <div class="card-box">
  <h4 class="m-t-0 header-title"><b>Trash</h4>
  <p class="text-muted m-b-30 font-13">
  Form ini digunakan untuk konfirmasi pembayaran saldo Anda
  </p>
  <div class="row">
    <div class="col-md-6">
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/paymentconfirmation') }}" enctype="multipart/form-data">
          {{ csrf_field() }} <!-- csrf field mencegah hacker-->
