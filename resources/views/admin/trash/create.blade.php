			...
			<section class="col-md-6 pd-t-15 pd-lr-15">
				<div class="sec-content-db">
					<div class="div-content-db">
						{!! Form::open(array('route' => 'trash.store', 'enctype' => 'multipart/form-data')) !!}

							<div class="form-group">
								<label class="control-label">Deskripsi : </label>
								<input type="text" name="trash_type" placeholder="Masukkan deskripsi tempat sampah" class="form-control">
							</div>
							<div class="form-group">
